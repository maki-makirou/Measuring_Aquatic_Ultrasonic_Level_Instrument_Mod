...
## 不使用部品
テストしたものの採用に至らなかった部品をメモ代わりに以下に記録します。いつか採用する日が来るかもしれません。
...
リード線を写真のように＋ーに割いてそれぞれに熱収縮チューブを通しておきます。ただし、ビニルテープの方がおすすめです。
...
写真のように2cmくらいリード線の被膜を剥きます。自分は爪切りを使って切れ目を付けてから剥いているのですが、ワイヤーストリッパーの方が楽に剥けると思います。
