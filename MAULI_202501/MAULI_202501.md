...
2cmくらいリード線の先端の被膜を剥いてください。ワイヤーストリッパー（AWG 18〜20）を使うと楽に剥けますが、爪切りでも剥けます。但し、初心者の方は失敗しがちなので（完全切断してしまいがち）、爪切りでやる場合は、延長用のリード線の方でじっくり練習してください。電池ボックスのリード線と延長用のリード線の両方を同じように剥きます。
...
熱収縮チューブを露出箇所に移動して温めて収縮させます。自分はSOTOのポケトーチを使っています。
